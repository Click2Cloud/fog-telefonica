...
describe "Fog::Baremetal[:telefonica] | Baremetal port requests" do
  before do
    @baremetal = Fog::Baremetal[:telefonica]
  ...
  describe "success" do
    ...
    before do
      ...
      @instance = Fog::Baremetal[:telefonica].create_node(node_attributes).body

      port_attributes = {
        :address   => '00:c2:08:85:de:ca',
        :node_uuid => @instance['uuid']
      }
      @port = Fog::Baremetal[:telefonica].create_port(port_attributes).body
    end
