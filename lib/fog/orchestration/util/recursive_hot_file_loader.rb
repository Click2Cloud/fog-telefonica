...
module Fog
  module Orchestration
    module Util
      ...
      #  https://developer.telefonica.org/api-ref/orchestration/v1/index.html?expanded=create-stack-detail#stacks
      #
      # Files present in :files are not processed further. The others
      #   are added to the Hash. This behavior is the same implemented in telefonica-infra/shade
      #   see https://github.com/telefonica-infra/shade/blob/1d16f64fbf376a956cafed1b3edd8e51ccc16f2c/shade/telefonicacloud.py#L1200
      #
      ...
      class RecursiveHotFileLoader
        ...
        def initialize(template, files = nil)
          # According to https://github.com/fog/fog-telefonica/blame/master/docs/orchestration.md#L122
        ...
        def get_file_contents(from_data, base_url)
          ...
          from_data.each do |key, value|
            ...
            #  by https://docs.telefonica.org/heat/pike/template_guide/hot_spec.html#get-file
